...
class ModelAssistant(Assistant):
    def __init__(self, intents, intent_methods={}, model_name="sophia"):
    ...
    def train_model(self):
        ...
        self.words = [self.lemmantizer.lemmatize(w.lower()) for w in self.words if w not in ignore_letters]
        ...
        for doc in documents:
            bag = []
            word_patterns = doc[0]
            word_patterns = [self.lemmantizer.lemmatize(word.lower()) for word in word_patterns]
    ...
    def _clean_up_sentence(self, sentence):
        ...
        sentence_words = [self.lemmantizer.lemmatize(word.lower()) for word in sentence_words]
